...
namespace IGPublicPcl
{
    ...
    public class IgRestService
    {
       ...
       /* public IgRestService(string env = "demo-api")
        ...
        {
            _baseUrl = "https://demo-api.ig.com";
        }

        public static void SetLiveMode()
        {
            _baseUrl = "https://api.ig.com";
        }
                ...
                case "DELETE":
                    {
                        ...
                        var myDeleteTask = client.SendAsync(request);*/
                       // var myDeleteTask = client.DeleteAsync(_baseUrl + uri);
                        client.DefaultRequestHeaders.Add("_method", "DELETE");
                        var myDeleteTask = client.PostAsync(_baseUrl + uri, scontent);
